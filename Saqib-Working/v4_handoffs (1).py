...
model = genai.GenerativeModel(os.getenv('MODEL', 'models/gemini-1.5-pro-latest'))
...
flight_agent = Agent(
    ...
    handoff_description="I can help you find and book the best flights for your trip. I can search for flights, compare prices, and recommend the best options based on your preferences.",
    instructions="""
    ...
    2. departure_time: The departure time as a string
    3. arrival_time: The arrival time as a string
    4. price: The price as a number (float)
    5. direct_flight: A boolean indicating if it's a direct flight
    6. recommendation_reason: A string explaining why this flight is recommended
...
hotel_agent = Agent(
    ...
    handoff_description="I can help you find the perfect accommodation for your trip. I can search for hotels, compare prices and amenities, and recommend the best options within your budget.",
    instructions="""
    ...
    2. location: The location as a string
    3. price_per_night: The price per night as a number (float)
    4. amenities: An array of strings listing available amenities
    5. recommendation_reason: A string explaining why this hotel is recommended
...
travel_agent = Agent(
    name="Travel Planner",
    handoff_description="I am your comprehensive travel planning assistant. I can help you plan your entire trip, including flights, hotels, activities, and provide weather information for your destination.",
    instructions="""
    ...
    IMPORTANT: You MUST respond with a valid JSON object that includes:
    1. destination: The name of the destination
    2. duration_days: The number of days as an integer
    3. budget: The budget as a number (float)
    4. activities: An array of strings describing recommended activities
    5. notes: A string containing additional recommendations and weather information
    
    Do not include any text outside the JSON object. The response must be valid JSON that can be parsed.
    
    When creating travel plans, ALWAYS consider:
    - The weather at the destination
    - Local attractions and activities
    - Budget constraints - if the budget is not realistic for the requested trip, respond with a message in the notes saying "Budget is likely unrealistic for this trip."
    - Travel duration
...
async def main():
    ...
    for query in queries:
        ...
        print("\nFINAL RESPONSE:")
        print("RAW RESULT:", result)  # Print the raw result for debugging
